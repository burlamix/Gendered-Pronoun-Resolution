...
flags.DEFINE_string("train_data_path", 'data/train.tsv',
    "Training .tsv data file")

flags.DEFINE_string("dev_data_path", 'data/development.tsv',
    "Development .tsv data file")
